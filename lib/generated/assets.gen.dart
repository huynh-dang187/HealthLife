...
class $AssetsLottieGen {
  ...
  /// Directory path: assets/lottie/intro
  $AssetsLottieIntroGen get intro => const $AssetsLottieIntroGen();
}
...
class $AssetsPngGen {
  ...
  /// File path: assets/png/ic_introduction2.png
  AssetGenImage get icIntroduction2 =>
      const AssetGenImage('assets/png/ic_introduction2.png');

  /// File path: assets/png/ic_introduction3.png
...
class $AssetsLottieIntroGen {
  const $AssetsLottieIntroGen();

  /// File path: assets/lottie/intro/intro.json
  String get intro => 'assets/lottie/intro/intro.json';
